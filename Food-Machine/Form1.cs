...
namespace Food_Machine
{
    public partial class Form1 : Form
    {
        ...
        private void MoneyEntered_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Mezelenirsen brat?");
                MoneyEntered.Text = "";
            }
        ...
        private void x_Click(object sender, EventArgs e)
        {
            ...
            if (total > enteredMoney)
                MessageBox.Show("Kasib, pulun yoxdu. Hele orda o boyda yazilibe catmir pulun");
            else
            {
                if(enteredMoney - total != 0)
                    MessageBox.Show($"Buyur brat puluvun qaligi {enteredMoney - total}");
                else
                    MessageBox.Show($"Sagol brat cano yiyim");
            }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (fs.CanRead == false)
                MessageBox.Show("Bibi oglu sehvdiye bu bele sey olar?");
            else
            {
